  ...
  return (
    <section id="registry" className="bg-[#fdfbf9] dark:bg-slate-800 py-24 px-6 text-center text-gray-800">
      <div className="max-w-2xl mx-auto">
        <Gift className="mx-auto mb-6 w-10 h-10 dark:text-pink-300 text-pink-600" />
        ...
        <button
          ...
          className="inline-block bg-pink-400 text-white text-lg font-medium py-3 px-6 rounded-full hover:bg-pink-700 transition"
        >
          Send a Gift
        </button>
      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-md w-full text-center">
            ...
            <div className="flex justify-center gap-4">
              <button
                onClick={handleCopy}
                className="bg-pink-400 text-white py-2 px-4 rounded-full hover:bg-pink-700 transition"
              >
                Copy Details
              </button>
              <button
